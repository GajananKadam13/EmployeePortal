...
{
    public class DL_ApproveRejectLeaves :DL_Base
    {

        public List<CT_Leave> GetEmployeeApplyLeaveApproveReject(int EmployeePKID)
        {
...
System.Configuration.ConfigurationManager.ConnectionStrings["Con_EMP_PORT"].ToString()
                ...
                using (oSQLConn)
                {
                    using (cmd = new System.Data.SqlClient.SqlCommand("GetEmployeeApplyLeaveApproveReject", oSQLConn))
                    {
        ...
        public List<CT_Leave> GetEmployeeParticularLeaves(int LeavePKID)
        {
            List<CT_Leave> CT_Leave_List = new List<CT_Leave>();
            try
            {
...
System.Configuration.ConfigurationManager.ConnectionStrings["Con_EMP_PORT"].ToString()
                ...
                using (oSQLConn)
                {
                    using (cmd = new System.Data.SqlClient.SqlCommand("GetEmployeeParticularLeaves", oSQLConn))
                    {
        ...
        public string ApproveRejectLeavesByManager(string Comment, string ddlApproveReject, int hdn_LeavePKID)
        {
            string returntype = "";
            try
            {
                using (con)
                {
                    using (cmd = new System.Data.SqlClient.SqlCommand("sp_ApproveRejectLeavesByManager", con))
                    {
